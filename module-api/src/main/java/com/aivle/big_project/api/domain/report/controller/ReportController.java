...
public class ReportController {
    ...
    @GetMapping("/daily")
    public ResponseEntity<ApiResponse<PagedResponse<DailyReportListResponse>>> getDailyReports(@ParameterObject Pageable pageable) {
    ...
    public ResponseEntity<ApiResponse<PagedResponse<IndividualReportListResponse>>> getIndividualReports(@ParameterObject Pageable pageable) {
